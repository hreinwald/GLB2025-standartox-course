...
The source code for this Rmarkdown report can be found [here](https://github.com/hreinwald/GLB2025-standartox-course).

To render this Rmarkdown simply run:
```{r, eval=FALSE}
rmarkdown::render("run_standartox.Rmd") # render the Rmd script 
```
...
For the next part of the course please refer to [standartox_examples.Rmd file](standartox_examples.Rmd).
