...
# We can use our custom plotting function again to display the values in a plot
plot_col_freq(q1.1, "endpoint")
plot_col_freq(q1.1, "concentration_unit")
```
...
m_types = q2$measurement %>% table %>% sort(decreasing = T)
head(m_types, 15) # show the top 15 results
...
We can plot the results of our query using `ggplot2`. 
```{r, eval=TRUE}
